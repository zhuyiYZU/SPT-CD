...
class Config(object):
    ...
    def __init__(self, dataset):
        ...
        self.class_list = [x.strip() for x in open(
            dataset + '/mutilModel/classes.txt', encoding='utf-8').readlines()]
...
class Model(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.fc_text = nn.Linear(config.hidden_size, config.num_classes)
        #图像
    ...
    def forward(self, x):
        ...
        text_output = self.fc_text(pooled_text)
        # print(text_output.shape)  #torch.Size([128, 2])
        ...
        # print(combined_features)  #torch.Size([128, 4])
